...
// ─── Module-scope Redis client references ────────────────────────────────────
// Declared here so gracefulShutdown can access them at process exit.
// Assigned inside mongoose.connection.on("connected") once Redis connects.
let pubClient       = null;
let subClient       = null;
let redisClient     = null;
let eventSubscriber = null;

// Lazy reference for health check
let lazyRedis = null;
...
mongoose.connection.on("connected", async () => {
    ...
    // Assign to module-scope variables
